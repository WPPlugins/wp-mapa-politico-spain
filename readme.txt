...
== 3.0.0 =
Esta nueva versión cambia la forma de mostrar imagenes y control de areas.
Es totalmente compatible con las opciones guardas de versiones anteriores
Incluye seleccion de color de las areas.
