...
class WP_Mapa_Politico_Settings {
	...
	private function settings_fields () {
		...
		$settings['inicio'] = array(
				...
				'description'			=> __( 'Bienvenido al WP Mapa Político España, plugin WordPress que te
											permitirá mostrar un mapa político de España con áreas seleccionables.', 'wpmps-plugin' ),
				'fields'				=> array(
						array(
								'id' 			=> 'inicio',
								'label'			=> '',
		...
		$settings['configuracion'] = array(
				...
				'description'			=> __( 'Configuración aspectos del plugin.', 'wpmps-plugin' ),
				'fields'				=> array(
												array(
														'id' 			=> 'background_color',
												...
												array(
														...
														'label'			=> __( 'Color del fondo defecto provincias', 'wpmps-plugin' ),
														'description'	=> __( 'Seleccione el color del fondo de las provincias.', 'wpmps-plugin' ),
														'type'			=> 'color',
														'default'		=> '#8098a8'
												),
												array(
														'id' 			=> 'hover_provincia_color',
														'label'			=> __( 'Color provincia activa', 'wpmps-plugin' ),
														'description'	=> __( 'Seleccione el color de activación de las provincias.', 'wpmps-plugin' ),
														'type'			=> 'color',
														'default'		=> '#265a82'
												),
											)
