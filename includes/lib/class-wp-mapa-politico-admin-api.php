...
class WP_Mapa_Politico_Admin_API {
	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
			...
			case 'inicio':
				...
				<div>
					<ol>
						...
						<li> ¿Quieres cambiar el color del fondo, o de las provincias ? pulsa <a href="<?php echo get_admin_url(); ?>options-general.php?page=wpmps_settings&tab=configuracion">aquí.</a></li>
						<li> Utiliza el shortcode <strong>[wpmps-map]</strong> en los post o páginas donde mostrar el mapa político.</li>

					</ol>
					<ul>
						<li> <strong>AVISO</strong> Esta nueva versión utiliza imágenes SVG, para obtener un plugin más ligero y compatible con la mayoría de los temas.</li>
					</ul>
				</div>
				<br />
        ...
        <h3>Valora el plugin <span class="cinco-estrellas"></span></h3>
				...
				<p> Detrás de este plugins hay un montón de horas de trabajo, muchas de ellas nocturnas, así que
					¿por qué no me invitas a un café? así podré seguir haciendo mejoras</p>
